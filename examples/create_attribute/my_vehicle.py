...
class RawIMU(object):
    ...
    This contains the true raw values without any scaling to allow data capture
    ...
    """
    def __init__(self, time_boot_us=None, xacc=None, yacc=None, zacc=None,
                 xygro=None, ygyro=None, zgyro=None, xmag=None, ymag=None,
                 zmag=None):
        """
    ...
    def __str__(self):
        ...
        """
        fmt = ('RAW_IMU\ntime_boot_us={},xacc={},yacc={},zacc={},'
               'xgyro={},ygyro={},zgyro={},xmag={},ymag={},zmag={}')
        return fmt.format(self.time_boot_us, self.xacc, self.yacc, self.zacc,
...
class MyVehicle(Vehicle):
    def __init__(self, *args):
        ...
        def listener(self, name, message):
            ...
            specified in the decorator, passing the vehicle, message name,
            and the message.
